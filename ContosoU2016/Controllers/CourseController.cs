...
namespace ContosoU2016.Controllers
{
    public class CourseController : Controller
    {
        ...
        //eallain: Reading related data
        //Build a custom method to return a sorted list of departments for our
        //dropdown filter
        ...
        //}
        public async Task<IActionResult> Index(int? SelectedDepartment) //if not connected to database can do "public ActionResult index"
        {
